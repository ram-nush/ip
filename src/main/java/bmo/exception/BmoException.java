...
public class BmoException extends Exception {
    ...
    public static final String BMO_INVALID_COMMAND_MESSAGE = "%s\n%s is not a valid command type!";
    ...
    /**
     * Creates a new <code>BmoException</code> with the relevant message and the suggestion
     * which resolves the message.
     *
