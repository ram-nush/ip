...
public class StorageCorruptedException extends BmoException {
    ...
    /**
     * Creates a new <code>StorageCorruptedException</code> with the relevant message
     * and a list of corrupted lines found in the save file.
     *
     * @param message The reason why the exception occurred
     * @param corruptedLines The list of corrupted lines found in the save file
     */
    ...
    /**
     * Creates a new <code>StorageCorruptedException</code> with the relevant message,
     * a suggestion which resolves the message and a list of corrupted lines found in the save file.
     *
     * @param message The reason why the exception occurred
     * @param suggestion The suggestion which the user can follow to resolve the message
     * @param corruptedLines The list of corrupted lines found in the save file
     */
